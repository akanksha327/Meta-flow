      ...
      <div className="hidden lg:flex lg:w-1/2 flex-col justify-center p-12 bg-primary-900 relative overflow-hidden">
        ...
        <div className="relative z-10 max-w-lg mx-auto text-center lg:text-left">
          ...
          <h2 className="text-5xl font-extrabold text-white leading-tight mb-6">
            Scale your API <span className="text-accent italic">without</span> the billing headaches.
          </h2>
          <p className="text-xl text-primary-300 leading-relaxed mb-12">
            The world's most transparent usage-based billing platform for modern developer tools.
          </p>
      ...
      <div className="w-full lg:w-1/2 flex items-center justify-center p-8 bg-surface dark:bg-surface-dark">
        <div className="w-full max-w-md">
          <div className="text-center lg:text-left mb-10">
            ...
            <h1 className="text-4xl font-bold text-textPrimary dark:text-white tracking-tight">Welcome Back</h1>
            <p className="text-textSecondary mt-3 text-lg">Log in to your developer dashboard</p>
          </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div className="flex items-center justify-between text-sm">
              <label className="flex items-center gap-2 cursor-pointer text-textSecondary">
                <input type="checkbox" className="rounded border-primary-200 text-accent focus:ring-accent" />
                Remember me
              </label>
            ...
            <Button type="submit" className="w-full py-4 text-lg font-bold shadow-xl shadow-accent/20" disabled={isSubmitting}>
              {isSubmitting ? 'Authenticating...' : isDemoMode ? 'Launch Dashboard' : 'Sign In'}
            </Button>
          </form>
          ...
          {isDemoMode && (
            <Button
              type="button"
              variant="outline"
              className="mt-4 w-full py-4 border-primary-200 hover:bg-primary-50"
              disabled={isSubmitting}
          ...
          <p className="text-center mt-10 text-textSecondary">
            New to MeterFlow? <Link to="/signup" className="text-accent hover:text-accent-dark font-bold transition-all border-b-2 border-accent/20 hover:border-accent pb-0.5">Create an account</Link>
          </p>
        </div>
      </div>
    </div>
